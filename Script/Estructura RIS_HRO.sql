/* ============================================================
   PROYECTO: RIS_HRO
   VERSION: 1.0 - Estructura inicial
   ============================================================ */
...
GO
   ...
   /*9. CAPACIDAD
   La capacidad se configura por categoría y día de la semana.
   DiaSemana:
...
(
    ...
    CONSTRAINT FK_CAPACIDAD_CAT_CATEGORIAS_PRUEBAS
        FOREIGN KEY (IdCategoria)
        REFERENCES dbo.CAT_CATEGORIAS_PRUEBAS(IdCategoria),
    ...
    CONSTRAINT UQ_CAPACIDAD_Categoria_Dia
        UNIQUE (IdCategoria, DiaSemana)
);
GO
...
(
    ...
    CONSTRAINT UQ_DETALLE_CITA_Cita_Prueba
        UNIQUE (IdCita, IdPrueba),
